  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Lab bench */}
        <rect x="0" y="276" width="400" height="44" fill="#c8d0db" />
        <rect x="0" y="272" width="400" height="6"  fill="#cbd5e1" />
        <rect x="0" y="272" width="400" height="2"  fill="rgba(255,255,255,0.55)" />
        ...
        {/* Glass vessel walls */}
        <rect x="48" y="26" width="204" height="164" rx="10"
          fill="rgba(255,255,255,0.46)" stroke="rgba(71,85,105,0.46)" strokeWidth="1.6" />
        {/* Glass sheen */}
        <path d="M 54 32 L 54 186" stroke="rgba(255,255,255,0.40)" strokeWidth="4" strokeLinecap="round" />
        <path d="M 62 32 L 62 186" stroke="rgba(255,255,255,0.14)" strokeWidth="1.8" strokeLinecap="round" />
        ...
        <g transform="translate(275, 28)">
          ...
          <text x="22" y="152" textAnchor="middle" fontSize="9.5" fill="#334155" fontWeight="800">{temperature}°C</text>
        </g>
        ...
        <g transform="translate(326, 28)">
          ...
          <text x="32" y="138" textAnchor="middle" fontSize="9.5" fill="#334155" fontWeight="800">{concentration.toFixed(1)} M</text>
        </g>

        {/* ── Rate multiplier badge ── */}
        <g transform="translate(50, 204)">
          <rect width="202" height="42" rx="8"
            fill="rgba(255,255,255,0.94)" stroke="rgba(148,163,184,0.28)" strokeWidth="1.2"
            filter="url(#rr-shadow)" />
          <text x="8" y="16" fontSize="8.5" fill="#475569" fontWeight="700" letterSpacing="0.05em">RATE MULTIPLIER</text>
          <text x="101" y="34" textAnchor="middle" fontSize="22" fill="#7c3aed" fontWeight="900">
        ...
        <g transform="translate(50, 254)">
          ...
          />
          <text x="202" y="26" textAnchor="end" fontSize="9" fill="#334155" fontWeight="800">
            {progress.toFixed(1)}%
          </text>
        </g>
